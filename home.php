   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            ...
            <h3></h3>
            <a href="category.php?category=frock" class="btn">Shop Now</a>
         </div>
      </div>
...
<section class="category">
   ...
   <a href="category.php?category=kurties" class="swiper-slide slide">
      
      <h3>Kurties</h3>
   </a>

   <a href="category.php?category=blesser" class="swiper-slide slide">
      
      <h3>Jeans</h3>
   </a>

   <a href="category.php?category=tshirts" class="swiper-slide slide">
